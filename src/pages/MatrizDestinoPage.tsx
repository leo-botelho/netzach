...
export default function MatrizDestinoPage() {
  ...
  if (!matriz || !profileData) return null;
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          <div className="bg-netzach-card border border-netzach-border rounded-xl p-6 hover:border-netzach-gold/30 transition-colors">
            ...
            <p className="text-sm text-netzach-muted">Arcano Principal: <span className="text-white font-bold">{ARCANOS[matriz.central.maior.arcano]}</span></p>
          </div>
          <div className="bg-netzach-card border border-netzach-border rounded-xl p-6 hover:border-netzach-gold/30 transition-colors">
            <h3 className="text-lg font-mystic text-netzach-gold mb-4 border-b border-netzach-border pb-2">Destino Pessoal</h3>
            <p className="text-sm text-netzach-muted">Até os 40 anos: <span className="text-white font-bold">{ARCANOS[matriz.propositos.pessoal.final]}</span></p>
          </div>
          <div className="bg-netzach-card border border-netzach-border rounded-xl p-6 hover:border-netzach-gold/30 transition-colors">
            <h3 className="text-lg font-mystic text-netzach-gold mb-4 border-b border-netzach-border pb-2">Dinheiro</h3>
            <p className="text-sm text-netzach-muted">Entrada: <span className="text-white font-bold">{ARCANOS[matriz.linhaPontilhada.primeiroDireita.arcano]}</span></p>
          </div>
        </div>
        ...
        <div className="text-center bg-gradient-to-r from-netzach-card to-[#2a1245] p-8 rounded-2xl border border-netzach-gold/50 shadow-2xl relative overflow-hidden">
            ...
            <h2 className="text-2xl font-mystic text-white mb-4">Quer desvendar todos os segredos?</h2>
            <p className="text-netzach-muted mb-8 max-w-xl mx-auto">A análise completa revela seus karmas, missão e talentos.</p>
